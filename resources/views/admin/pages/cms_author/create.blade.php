                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="title" placeholder="@lang('Họ Và tên')"
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="birthday" placeholder="@lang('Năm sinh')"
                        value="{{ old('birthday') }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-control">
                          ...
                          <label>
                              <input type="radio" name="hienthi" value="0" checked=""
                                  class="ml-15">
                              <small>Không</small>
                          </label>
                      </div>
