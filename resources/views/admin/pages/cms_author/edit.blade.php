                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="birthday"
                        placeholder="@lang('Năm sinh')"
                        value="{{ $detail->birthday ?? old('birthday') }}">
                    </div>
                  </div>

                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Hiển thị nổi bật trang chủ <small class="text-red">*</small></label>
                      <div class="form-control">
                        <label>
                          <input type="radio" name="hienthi" value="1" <?php if($detail->hienthi == 1) echo 'checked'; ?>>
                          <small>Có</small>
                        </label>
                        <label>
                          <input type="radio" name="hienthi" value="0" <?php if($detail->hienthi == 0) echo 'checked'; ?>
                            class="ml-15">
                          <small>Không</small>
                        </label>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="description" placeholder="@lang('Mô tả')"
                        value="{{ $detail->description ?? old('description') }}">
                    </div>
                  </div>
