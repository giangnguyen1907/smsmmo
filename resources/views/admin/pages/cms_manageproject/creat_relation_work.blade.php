...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form role="form" action="{{ route('admin.store_relation_work') }}" method="POST"
                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <button type="submit" class="btn btn-danger pull-right btn-sm mg-5" name="submit">Lưu công
                                việc</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="file_work[]" type="file"
                                                multiple="multiple" title="Chọn tệp tải lên" placeholder="Chọn tệp tải lên">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control">
                                                <input type="radio" name="is_public" value="0"
                                                    class="check-all-congkhai" checked="">
                                                Cá nhân
                                    ...
                                    <div class="col-md-6" id="noinhan">
                                        <div class="form-group hidden">
                                            ...
                                            <select class="form-control select2" onchange="loadMemberDepartment()"
                                                id="check_department">
                                                        ...
                                                        <tr>
                                                            <th class="col-xs-4">
                                                                <input class="checkbox check-all" type="checkbox"
                                                                    value="0"><span>Chọn tất cả</span>
                                                            </th>
                                                            <th class="col-xs-8">
                                                                <input class="checkbox check-all-relative" type="checkbox"
                                                                    value="0"><span>Người tham gia</span>
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="load-ajax">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="">
                                                                    <?php foreach($admins as $admin){ 
                                                                      ...
                                                                      ?>
                                                                    <input
                                                                        class="checkbox _check_all _check_relative _check_all_{{ $department->id }}"
        ...
        <div class="box-footer">
            ...
            <button type="submit" class="btn btn-danger pull-right btn-sm mg-5" name="submit" value="gui">Lưu công
                việc</button>
