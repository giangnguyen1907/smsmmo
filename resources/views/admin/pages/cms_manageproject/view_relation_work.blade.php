        ...
        <h1>
            ...
            @if ($manage_created_id == Auth::guard('admin')->user()->id)
                <a class="btn btn-sm btn-warning pull-right"
                    href="{{ route('admin.creat_relation_work', ['id' => $manage_id]) }}"> <i class="fa fa-plus"></i>
                    @lang('Add')</a>
            @endif
        </h1>
    </section>
                                ...
                                @if ($manageWork->relationWorks->count() > 0)
                                    @foreach ($manageWork->relationWorks as $relationWork)
                                        @php
                                            ...
                                            $userCanAccess =
                                                in_array(Auth::guard('admin')->user()->id, $userIds) ||
                                                Auth::guard('admin')->user()->id == $relationWork->admin_created_id ||
                                                $relationWork->is_public == 1;
                                        @endphp
                                        @if ($userCanAccess)
                                            <div class="col-md-4"
                                                style="padding-right: 15px;padding-top:15px; background-color: #ebecee;border-right: 1px dotted #c0c1c2;">
                                                        ...
                                                        <div class="panel-heading"
                                                            ...
                                                            <div class="btn-group pull-right">
                                                                ...
                                                                <button type="button" class="btn btn-default btn-sm"
                                                                    data-toggle="modal"
                                                                    data-target="#detailModal{{ $relationWork->id }}"><span
                                                                        class="glyphicon glyphicon-eye-open"></span></button>

                                                                <div class="modal fade"
                                                                    id="detailModal{{ $relationWork->id }}"
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                ...
                                                                                <h4 class="modal-title">Xem chi tiết công
                                                                                    việc</h4>
                                                                            </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            @if ($relationWork->is_public == 1)
                                                                                                <div
                                                                                                    ...
                                                                                                    <img src="{{ asset('themes/admin/img/user.png') }}"
                                                                                                        alt="Tất cả người dùng trong hệ thống"
                                                                                                        class="img-circle"
                                                                                                        style="width: 50px;">
                                                                                                    <p
                                                                                                ...
                                                                                                @foreach ($userIds as $userId)
                                                                                                    ...
                                                                                                    @if ($user)
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img src="{{ $user->avatar ?? asset('themes/admin/img/user.png') }}"
                                                                                                                alt="{{ $user->name }}"
                                                                                                                class="img-circle"
                                                                                                                style="width: 50px;"
                                                                                                                data-toggle="tooltip"
                                                                                                            ...
                                                                                                            <p
                                                                                                                style="font-size:15px">
                                                                                                                {{ $user->name }}
                                                                                                                {{-- ({{ Illuminate\Support\Str::limit($user->email, 13) }}) --}}
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    @endif
                                                                                                @endforeach
                                                                                        ...
                                                                                        <p style="font-size:15px">
                                                                                            ...
                                                                                            {{ date('d-m-Y H:i', strtotime($relationWork->deadline)) }}
                                                                                        </p>
                                                                ...
                                                                @if (Auth::guard('admin')->user()->id == $relationWork->admin_created_id)
                                                                    <a type="button" class="btn btn-default btn-sm"
                                                                        href="{{ route('admin.edit_relation_work', ['id' => $relationWork->id]) }}"><span
                                                                            class="glyphicon glyphicon-pencil"></span></a>

                                                                    <a type="button" class="btn btn-default btn-sm"
                                                                        onclick="deleteRelationWork({{ $relationWork->id }})"><span
                                                        ...
                                                        <div class="panel-body" style="padding-top:25px">
                                                                ...
                                                                <div class="status-container">
                                                                    ...
                                                                    @if ($relationWork->admin_created_id == Auth::guard('admin')->user()->id)
                                                                        <select class="form-control select-status"
                                                                            data-relation-work-id="{{ $relationWork->id }}">
                                                                            <option value="">Thay đổi trạng thái
                                                                            </option>
                                                                ...
                                                                <div class="col-xs-6">
                                                                    @if ($relationWork->is_public == 1)
                                                                        <img src="{{ asset('themes/admin/img/user.png') }}"
                                                                            ...
                                                                            title="Tất cả người dùng trong hệ thống"> Tất
                                                                        cả người dùng
                                                                    @else
                                                                        @if ($relationWork->user_work)
                                                                            @php
                                                                                $userIds = explode(
                                                                                    ',',
                                                                                    $relationWork->user_work,
                                                                                );
                                                                                $users = \App\Models\Admin::whereIn(
                                                                                    'id',
                                                                                    $userIds,
                                                                                )->get();
                                                            ...
                                                            <div class="col-xs-4">
                                                                <div class="text-muted" style="margin-top: 5px">
                                                                    {{ date('d-m-Y', strtotime($relationWork->deadline)) }}
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-2">
                                                                <a type="button" class="btn btn-default btn-sm"
                                                                    data-toggle="modal"
                                                                    data-target="#historyModal{{ $relationWork->id }}">
                                                                    <span class="glyphicon glyphicon-comment"></span>
                                                                    {{ $relationWork->historyWorks->count() }}
                                                                </a>
                                                                <div class="modal fade"
                                                                    id="historyModal{{ $relationWork->id }}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    aria-label="Close"><span
                                                                                        aria-hidden="true">×</span></button>
                                                                                <h4 class="modal-title">Lịch sử báo cáo
                                                                                    công việc: <span
                                                                                        style="color:red">{{ $relationWork->title }}</span>
                                                                                </h4>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                                ...
                                                                                                <div class="media">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <h4 class="media-heading"
                                                                                                            ...
                                                                                                            {{ $historyWork->user->name }}
                                                                                                            ({{ $historyWork->user->email }})
                                                                                                        </h4>
                                                                                                        @if ($historyWork->status == 'prioritize')
                                                                                                            <a
                                                                                                                class="status prioritize">
                                                                                                                @lang($historyWork->status)
                                                                                                            </a>
                                                                                                        ...
                                                                                                        @elseif($historyWork->status == 'reprocess')
                                                                                                            <a
                                                                                                                class="status reprocess">
                                                                                                                @lang($historyWork->status)
                                                                                                            </a>
                                                                                                        @endif
                                                                                                        <p
                                                                                                            style="margin: 10px 0 10px;font-size: 15px">
                                                                                                            {{ $historyWork->comment }}
                                                                                                        </p>
                                                                                                        @foreach ($historyWork->fileRelationHis as $fileRelationH)
                                                                                                            <a style="margin: 10px 0 10px;font-size: 14px; cursor:pointer"
                                                                                                                target="_blank"
                                                                                                                download
                                                                                                                href="{{ $fileRelationH->link_file }}">{{ $fileRelationH->name }}</a><br>
                                                                                                        @endforeach
                                                                                                        <p
                                                                                                            style="margin: 10px 0 10px;">
                                                                                                            <small
                                                                                                                class="text-muted">{{ date('d-m-Y H:i', strtotime($historyWork->created_at)) }}</small>
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </li>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <hr
                                                                                        style="border-top: dashed 2px #a94442; margin: 10px 0px;">
                                                                                </div>
                                                                                <ul class="list-group">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <button type="button"
                                                                                                    ...
                                                                                                    id="toggleCommentForm{{ $relationWork->id }}"
                                                                                                    onclick="toggleCommentForm({{ $relationWork->id }})">Thêm
                                                                                                    mới</button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div
                                                                                            id="commentFormWrapper{{ $relationWork->id }}">
                                                                                            <form
                                                                                                id="commentForm{{ $relationWork->id }}"
                                                                                                method="POST"
                                                                                                data-form-id="{{ $relationWork->id }}"
                                                                                                action="{{ route('cms_work.store_history_work') }}"
                                                                                                style="display: none;"
                                                                                                enctype='multipart/form-data'>
                                                                                                @csrf
                                                                                                <input type="hidden"
                                                                                                    value="{{ $relationWork->id }}"
                                                                                                    name="relation_work_id"
                                                                                                    id="relation_work_id">
                                                                                                <input type="hidden"
                                                                                                    value="{{ $manageWork->id }}"
                                                                                                    name="manage_work_id"
        ...
        $('.select-status').change(function() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    alert(
                        'Cập nhật trạng thái công việc không thành công, vui lòng thử lại.');
                }
            });
        });
