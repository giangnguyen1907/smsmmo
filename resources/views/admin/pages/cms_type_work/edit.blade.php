              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>@lang('Tên loại công việc') <small class="text-red">*</small></label>
                    <input type="text" class="form-control" name="title" id="txtTitle" placeholder="@lang('Tên loại công việc')" value="{{ $detail->title }}" required>
                  </div>
                </div>
