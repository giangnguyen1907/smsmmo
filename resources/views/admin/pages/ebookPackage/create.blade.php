                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="book_type" class="form-control">
                                                ...
                                                <option value="{{ $key_type }}"> {{ $title_type }} </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="time"
                                                placeholder="Thời gian" value="{{ old('time') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="recipe" class="form-control">
                                                ...
                                                <option value="<?= $key ?>"> <?= $title_recipr ?> </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price"
                                                placeholder="Giá (1 trang/MB)" value="{{ old('price') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="percent"
                                                placeholder="X% giá sách giấy" value="{{ old('percent') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="rounding" class="form-control">
                                                ...
                                                <option value="{{ $key_round }}"> {{ $title_round }} </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="min_price"
                                                placeholder="Giá tối thiểu" value="{{ old('min_price') }}" required>
                                        </div>
                                    </div>
