...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route(Request::segment(2) . '.update', $service->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="box-body">
                    <!-- Custom Tabs -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea name="description" id="brief" class="form-control" rows="5">{{ $service->description }}</textarea>
                                        </div>
                                            ...
                                            <div class="row">
                                              <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="price_per_unit" 
                                                    placeholder="price" value="{{ $service->price_per_unit }}">
                                              </div>
                                            ...
                                            <div class="row">
                                              <div class="col-md-6">
                                                  ...
                                                  <input type="number" class="form-control" name="duration_minutes" 
                                                    placeholder="duration minutes" value="{{ $service->duration_minutes }}">
                                              </div>
