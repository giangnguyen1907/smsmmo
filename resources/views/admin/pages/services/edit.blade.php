                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                @foreach ($taxonomys as $item)
												  @if ($item->parent_id == 0 || $item->parent_id == null)
													<option value="{{ $item->id }}"
													  {{ $detail->taxonomy == $item->id ? 'selected' : '' }}>{{ $item->title->$locale }}</option>

													@foreach ($taxonomys as $sub)
													  @if ($item->id == $sub->parent_id)
														<option value="{{ $sub->id }}"
														  {{ $detail->taxonomy == $sub->id ? 'selected' : '' }}>- - {{ $sub->title->$locale }}
														</option>

														@foreach ($taxonomys as $sub_child)
														  @if ($sub->id == $sub_child->parent_id)
															<option value="{{ $sub_child->id }}"
															  {{ $detail->taxonomy == $sub_child->id ? 'selected' : '' }}>- - - -
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea name="brief" id="brief" class="form-control" rows="5">{{ $detail->brief }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="url_part" id="txtUrlPart"
                                                ...
                                                placeholder="@lang('Alias')" value="{{ $detail->url_part }}"
                                                required>
                                        </div>
                                                  ...
                                                  <select name="news_position" class="form-control" id="news_position">
                                                      ...
                                                      @foreach ($array_location as $key => $position_text)
                                                          <option style="font-size: 15px" value="{{ $key }}"
                                                              {{ $detail->news_position == $key ? 'selected' : '' }}>
                                            ...
                                            <div class="row">
                                              <div class="col-md-6">
                                                  ...
                                                  <input type="text" class="form-control" name="price" 
                                                    placeholder="price" value="{{ $detail->price }}">
                                              </div>
