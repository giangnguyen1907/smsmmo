                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="discount" placeholder="@lang('Discount')"
                        value="{{ $detail->discount ?? old('discount') }}" required>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local" class="form-control" name="end_date" placeholder="@lang('End date')"
                        value="{{ $detail->end_date ?? old('end_date') }}" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-control">
                          ...
                          <label>
                              <input type="radio" name="status" value="{{$key}}" <?php if($key==$detail->status) echo 'checked'; ?> class="ml-15" >
                              <small>{{ $val }}</small>
                          </label>
                          <?php } ?>
                      </div>
