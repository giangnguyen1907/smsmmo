            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-innerbannercontent">
                        <h1 class="p-4 hidden">
                            {{ $array_translate[strtolower('Document list')]->$locale ?? 'Document list' }}</h1>
                        <ol class="tg-breadcrumb">
                            <li><a href="/">{{ $array_translate[strtolower('Home')]->$locale ?? 'Home' }}</a></li>
                            <li class="tg-active">
                                {{ $array_translate[strtolower('Document list')]->$locale ?? 'Document list' }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div id="tg-content" class="tg-content">
                                <div class="tg-newslist">
                                    <div class="tg-sectionhead" style="display: flex; justify-content: space-between; ">
                                        <h2>{{ $array_translate[strtolower('Document list')]->$locale ?? 'Document list' }}
                                        </h2>
											...
											<article class="tg-post books-grid">
												...
												<div class="tg-postcontent" >
													...
													<ul class="tg-postmetadata">
														<li><a href="javascript:void(0);"><i class="fa fa-file-pdf-o" aria-hidden="true"></i><i>{{ $item->number_page }}p</i></a></li>
														<li><a href="javascript:void(0);"><i class="fa fa-eye"></i><i>{{ $item->view }}</i></a></li>
														<li><a href="javascript:void(0);"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i><i>{{ $item->download }} </i></a></li>
													</ul>
												</div>
											</article>
										</div>
