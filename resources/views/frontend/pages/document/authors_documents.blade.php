            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-innerbannercontent">
                        <h1 class="p-4 hidden">
                            {{ $array_translate[strtolower('Document list by author')]->$locale ?? 'Document list by author' }}
                        </h1>
                            ...
                            <div id="tg-content" class="tg-content">
                                <div class="tg-newslist">
                                    <div class="tg-sectionhead"
                                        style="display: flex; justify-content: space-between; padding: 0 0 0px 0;">
                                        <h2>{{ $array_translate[strtolower('Document list by author')]->$locale ?? 'Document list by author' }}
                                        </h2>

                                        <div class="view-mode-toggle">
                                            <button id="grid-view-btn" class="btn-view"><i class="fa fa-th"></i></button>
                                            <button id="list-view-btn" class="btn-view active"><i
                                    ...
                                    <div class="row view-doc-container list-view-doc">
                                        @foreach ($posts as $item)
                                            @php
                                                ...
                                                $url = route('frontend.cms.view', ['alias' => $item->alias]) . '.html';
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 view-doc-col">
                                                <article class="tg-post">
													...
													@else
														...
														}else if($encodeFilePdf =='' and $encodeFileOther ==''){
