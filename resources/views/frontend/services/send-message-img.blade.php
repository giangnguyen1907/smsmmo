    ...
    <div class="card-body">
        <div class="profile-form-section">
            ...
            <form method="POST" action="#">
                ...
                <div class="form-group">
                    <label for="noidungtinnhan">Nội dung:</label>
                    <input type="text" id="noidungtinnhan" name="noidungtinnhan" class="form-control" value="DpH7pDWw27" required>
                </div>

                <div class="form-group">
                    <label for="rdnd">Số lượng tin nhắn:</label>
                    <input type="text" id="rdnd" name="rdnd" class="form-control" value="789" required>
                </div>
                ...
                <p class="text-danger">Tổng nạp phải lớn hơn 51,000 để tạo ảnh miễn phí.</p>
